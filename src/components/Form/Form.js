    ...
    return (
        <FormStyled onSubmit={handleSubmit}>
            ...
            <div className='input-control'>
                <input type='text' value={title} name="title" placeholder='Salary Title' onChange={handleInput} />
            </div>
            <div className='input-control'>
                <input type='text' value={amount} name="amount" placeholder='Salary amount' onChange={handleInput} />
            </div>
            <div className='input-control'>
            ...
            <div className='submit-btn'>
              <Button name={"Add Income"} icon={plus} bPad={'.8rem 1.6rem'} bRad={"30px"} bg={'var(--color-accent)'} color={"#fff"} hColor={"red"}
              />
            </div>
